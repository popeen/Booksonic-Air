...
<c:set var="categories" value="${param.restricted ? 'personal password player share' : 'musicFolder general advanced personal user player share dlna transcoding internetRadio podcast database'}"/>
<h1>
