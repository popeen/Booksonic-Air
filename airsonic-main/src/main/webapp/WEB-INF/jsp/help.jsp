...
<table width="75%" class="ruleTable indent">
    ...
    <tr><td class="ruleTableHeader"><fmt:message key="help.version.title"/></td><td class="ruleTableCell">${versionString} &ndash; ${buildDateString}, based on <a href='https://github.com/airsonic/airsonic/commit/8b28366' target='_blank'>Airsonic 8b28366</a></td></tr>
