...
<table width="75%" class="ruleTable indent">
    ...
    <tr><td class="ruleTableHeader"><fmt:message key="help.version.title"/></td><td class="ruleTableCell">${versionString} &ndash; ${buildDateString}, based on <a href='https://github.com/airsonic/airsonic/commit/8b28366' tareget='_blank'>Airsonic 8b28366</a></td></tr>
    ...
    <tr><td class="ruleTableHeader"><fmt:message key="help.homepage.title"/></td><td class="ruleTableCell"><a target="_blank" href="https://booksonic.org" rel="noopener nofererrer">Booksonic website</a></td></tr>
    <tr><td class="ruleTableHeader"><fmt:message key="help.forum.title"/></td><td class="ruleTableCell"><a target="_blank" href="https://www.reddit.com/r/booksonic" rel="noopener noreferrer">Booksonic on Reddit</a></td></tr>
