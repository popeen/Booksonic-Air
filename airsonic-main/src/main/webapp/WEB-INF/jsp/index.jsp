...
<frameset rows="80,*,0" border="0" framespacing="0" frameborder="0">
    ...
    <frameset id="mainFrameset" cols=${model.showSideBar ? "420,*" : "0,*"} border="0" framespacing="0" frameborder="0">
        <!--<frame name="left" src="left.view?" marginwidth="0" marginheight="0" class="bgcolor2">-->
        <frame name="playQueue" src="playQueue.view?" marginwidth="0" marginheight="0" class="bgcolor2">

        <frameset id="playQueueFrameset" rows=${model.autoHidePlayQueue ? "*,0" : "*,0"} border="0" framespacing="0" frameborder="0">
